...
public extension SynchronizedArray {
    ...
    func reduce<ElementOfResult>(_ initialResult: ElementOfResult,
        ...
        (ElementOfResult, Element) -> ElementOfResult) -> ElementOfResult {
        var result: ElementOfResult?
    ...
    func reduce<ElementOfResult>(
        ...
        _ updateAccumulatingResult: @escaping (inout ElementOfResult, Element) -> ()) -> ElementOfResult {
        var result: ElementOfResult?
...
public extension SynchronizedArray {
    ...
    ///  as its argument and returns a Boolean value indicating whether the element is a match.
